/**
 * Tool contract for the CRM environment.
 *
 * The contract comes from Silo. This module pins it to this environment's state
 * type and re-exports it next to the schema builders and input readers every CRM
...
/** A CRM tool: a Silo tool bound to this environment's state. */
export type CrmTool = SiloTool<State>;

/** `defineTool` with the CRM state type already applied. */
